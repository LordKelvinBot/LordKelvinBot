  ...
  switch (args[0].toLowerCase()) {
    ...
    */
    ...
    case "purge":
      ...
      if (message.author.id == '181284528793452545' || (message.member.hasPermission("ADMINISTRATOR")) || (message.guild.id == '272582751545196544' && (message.member.roles.cache.has(roleGod.id) || message.member.roles.cache.has(roleGod1.id))) {
        let newamount = 2;
        if (args[1]) {
          newamount = args[1];
        }
