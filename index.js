...
bot.on("message", async message => {
  ...
  function getSubredditImage() { //methods
    ...
    const render = post => {
      ...
      image1 = new Discord.MessageEmbed()
        .setTitle(post.title)
        .addField(post.img);
  ...
  switch (args[0].toLowerCase()) {
    ...
    case "img":
      if (!args[1]) {
        var imgEmbed = new Discord.MessageEmbed()
    ...
    case "tierlist":
      if (!args[1]) {
        let tierlists = new Discord.MessageEmbed()
    ...
    /*case "colors":
      ...
      var embed999 = new Discord.MessageEmbed()
    ...
    */
    ...
    case "urbanr":
      urban.random().first(json => {
        let urbanEm = new Discord.MessageEmbed()
          .setTitle(json.word)
    ...
    case "help":
      if (!args[1]) {
        ...
        switch (args[1]) {
          ...
          case "subs":
          case "subhelp":
            var subhelp = new Discord.MessageEmbed()
              .setColor(generateHex())
    ...
    case "math":
      ...
      switch (args[1].toLowerCase()) {
        ...
        case "log":
          ...
          break;
        case "test":
          var mathtestingembed = new Discord.MessageEmbed();
          for (var i = 0; i < args.length; i++) {
    ...
    case "test9":
      ...
      break;
    case "test10":
      let test10 = new Discord.MessageEmbed()
