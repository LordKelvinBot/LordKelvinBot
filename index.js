        ...
        case "devs":
          ...
          var embed11 = new Discord.RichEmbed()
            ...
            .addFields({
              ...
              break;
              case "dab":
              var rand = Math.floor(Math.random() * dabArray.length); log("*Dab Command Received*\nFile: " + dabArray[rand] + "\nRand: " + rand); message.channel.send({
              ...
              case "d":
              var num = args[1];
              if (isNaN(num)) return message.channel.send("Use a number dumbass"); message.channel.send(Math.floor(Math.random() * num) + 1);
              break;
              case "randorder":
              var num = args[1];
              if (isNaN(num)) return message.channel.send("Use a number dumbass");
              ...
              break;
              case "say":
              var sayMessage = args.join(" "); sayMessage = sayMessage.replace("say ", ""); message.delete().catch(O_o => {}); message.channel.send(sayMessage);
              break;
              case "xkcd":
              if (args[1]) {
                getXKCD(args[1]);
              ...
              break;
              case "pusharray":
              goodArray.push(args[1]); message.channel.send("The current array is: ");
              ...
              message.member.addRole(role11).catch(console.error); message.channel.send("You now have access to the console. If you don't want this anymore, use 'denyconsole'");
              break;
              case "denyconsole":
              let role22 = message.guild.roles.find("name", "console.log.perms"); message.member.removeRole(role22).catch(console.error); message.channel.send("You no longer have access to the console.");
              break;
              case "hello":
              message.channel.send("I'm back in black");
              break;
              case "cleararray":
              goodArray = []; message.channel.send("List Cleared.");
              break;
              case "shufflearray":
              var link = goodArray[randomNumber(goodArray.length)]; message.channel.send("From the subreddit /r/" + link); randomPuppy(link)
              .then(url => {
              ...
              case "test7":
              if (!args[2]) return message.channel.send("No args[2] present"); message.channel.send(args[2]);
              break;
              case "test8":
              message.channel.send(message.content);
              break;
              case "test9":
              plaympeg("Sands.mp3") break;
              case "test10":
              let test10 = new Discord.RichEmbed()
                .addField("test one", "test two", true)
                .addField("test three", "test four", true); message.channel.send(test10);
              break;
              case "test11":
              ...
              break;
              case "test12":
              message.channel.send("A: " + message.author.toString()); message.channel.send("B: " + message.author);
              break;
              case "test13":
              ...
              var embed = new Discord.RichEmbed()
                ...
                .addField("Fredboat", ";;")
                .addField("Groovy", "--")
                .addField("Wings", "w."); message.channel.send(embed);
              ...
              break;
              case "embedtest":
              var embed = new Discord.RichEmbed(); embed.setDescription("Test embed my guy this is the description i think"); embed.addField("What is a field what is life what", "HELP ME"); embed.addField("What is a field what is life what", "HELP ME"); embed.addField("What is a field what is life what", "HELP ME"); embed.addField("What is a field what is life what", "HELP ME"); message.channel.send(embed);
              break;
              case "noticeme":
              ...
              var reported = args.splice(0, untilFor); reported.splice(reported.indexOf('foo'), 1); reported.splice(reported.indexOf("report"), 1); message.channel.send("You reported " + reported.join(" ") + ".");
              ...
              return; message.channel.send("Didn't work");
              break;
              case "roulette":
              ...
              case "largeembed":
              var i = 1;
              var embed0 = new Discord.RichEmbed(); embed0.setDescription("Numbers My Guy");
              while (i <= args[1]) {
                if (i > 24) {
                  return;
                }
              ...
              break;
              case "version":
              var VERSION = config.version; message.channel.send(VERSION);
              break;
              case "changelog":
              var embedlog = new Discord.RichEmbed();
              var CHANGELOG = config.changelog
              embedlog.setTitle("Change Log")
              .addField(config.version, CHANGELOG); message.channel.send(embedlog);
              break;
              case "skip":
              var server = servers[message.guild.id];
              if (server.dispatcher) server.dispatcher.end(); server.queue.shift();
              break;
              case "stop":
              var server = servers[message.guild.id];
